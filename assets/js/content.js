window.COURSE_CONTENT = {
  objectives: [
    { title: "Entender el valor de los datos", description: "Reconocer por qué los datos tienen un rol central en la tecnología y en las decisiones actuales." }, // Define el objetivo específico 1 y su explicación visible en la web.
    { title: "Detectar patrones y tendencias", description: "Identificar relaciones, repeticiones y señales relevantes dentro de distintos tipos de información." }, // Define el objetivo específico 2 y lo conecta con la búsqueda de patrones.
    { title: "Comprender análisis de datos e IA", description: "Introducir conceptos esenciales de ciencia de datos e inteligencia artificial con lenguaje accesible y aplicado." }, // Define el objetivo específico 3 con foco en conceptos base de IA y datos.
    { title: "Razonar con evidencia", description: "Desarrollar pensamiento analítico, formular preguntas y respaldar conclusiones con información verificable." }, // Define el objetivo específico 4 para reforzar el pensamiento científico.
    { title: "Interpretar visualizaciones", description: "Leer tablas, porcentajes, gráficos y otras representaciones simples para extraer hallazgos." }, // Define el objetivo específico 5 relacionado con visualización de información.
    { title: "Resolver desafíos en equipo", description: "Observar, analizar, argumentar y comunicar ideas de manera colaborativa frente a problemas reales." }, // Define el objetivo específico 6 con foco en trabajo grupal y comunicación.
    { title: "Proyectar la ciencia de datos", description: "Comprender su impacto en distintas áreas del conocimiento, la universidad y el mundo laboral." } // Define el objetivo específico 7 y muestra la proyección futura de la disciplina.
  ],
  sessions: [
    {
      number: 1,
      ...
      materials: [
        { label: "Ver presentación", path: "materials/sesion-01/presentacion-sesion-01.html", action: "view" }, // Abre una versión web desplegable de la presentación de la sesión 1.
        { label: "Guía del estudiante", path: "materials/sesion-01/guia-estudiante-sesion-01.docx", action: "download" } // Descarga la guía original en Word desde la carpeta materials.
      ]
  ...
  library: [
    {
      ...
      description: "Versión web de la presentación principal: ciencia de datos, ciclo del dato, analista vs. científico, evidencia y actividades iniciales.",
      type: "PPTX",
      session: "Sesión 1",
      path: "materials/sesion-01/presentacion-sesion-01.html",
      action: "view"
    }, // Mantiene la presentación dentro del filtro de presentaciones y la abre en formato web.
    {
      ...
      action: "download"
    }, // Registra la guía original de la sesión 1 dentro de la biblioteca descargable.
    {
    ...
    }, // Registra el ejercicio original de carta Gantt realizado durante la sesión 2.
    {
      ...
      type: "DOCX",
      session: "Programa",
      path: "materials/programa/programa-taller.html",
      action: "view"
    } // Abre una versión web del programa para evitar enlaces rotos y mantener el contenido accesible desde Pages.
  ]
}; // Centraliza el contenido editable del sitio para que futuras sesiones se agreguen sin modificar el HTML principal.